...
echo -e "║ 1) Welcome TUNNELING V2.4"
echo -e "║ 2) Menu TUNNELING V2.4"
...
case $pilih in
  1) welcome ;;
  2) menu ;;
  3) wget -q https://raw.githubusercontent.com/Pemulaajiw/udp-zivpn/main/zivpn-manager -O /usr/local/bin/zivpn-manager \
